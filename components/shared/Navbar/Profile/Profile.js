                            ...
                            <Stack alignItems="center" spacing={2}>
                                ...
                                {!matches && 
                                    <Stack paddingX={4} spacing={1}>
                                        <Typography textAlign="center" noWrap style={{fontWeight: "600"}}>{name}</Typography>
                                        {typeAccount === 1 && 
                                            <Typography textAlign="center" noWrap style={{fontWeight: "600"}}>Admin</Typography>
                                        }
                                    </Stack>
                                }
                    ...
                    { !openMenu &&
                        <>
                            <Stack alignItems="center" spacing={2}>
                                ...
                                <Stack onClick={handleLogout} style={{ cursor: "pointer"}}>
                                    <Image src={LogoutIcon.src} width={openMenu ? 24 : 32} height={openMenu ? 24 : 32} alt="Logout" />
                                </Stack>
                            </Stack>
                        </>
                    }
