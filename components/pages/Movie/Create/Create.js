...
const Create = (props) => {
  ...
  return (
    <form method="POST" onSubmit={handleUpsert}>
      <Layout>
        <Stack spacing={4}>
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              ...
              <Stack direction="row" spacing={4}>
                ...
                <TextField
                  ...
                  onChange={(event) =>
                    setMovieData({ ...movieData, ageGroup: event.target.value })
                  }
                >
                ...
                <TextField
                  ...
                  onChange={(event) =>
                    setMovieData({ ...movieData, hours: event.target.value })
                  }
                />
                <TextField
                  type="input"
                  ...
                  onChange={(event) =>
                    setMovieData({ ...movieData, minutes: event.target.value })
                  }
                />
              </Stack>
              <TextField
              ...
              <TextField
                ...
                onChange={(event) =>
                  setMovieData({ ...movieData, poster: event.target.value })
                }
              />
