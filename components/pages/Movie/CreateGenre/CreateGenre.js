        ...
        <Layout>
            <Stack spacing={4}>
                <Stack direction='row' alignItems="center" spacing={4}>
                    <Text size="medium" color="primary">Vincular Gênero ao Filme</Text>
                </Stack>
                <Stack spacing={2}>
                    <Stack direction="row" spacing={4}>
                        <FormControl sx={{ minWidth: "200px"}}>
                            <InputLabel id="select-genre-label" size="small">Gênero</InputLabel>
                            <Select
                            ...
                            >
                                {listGenres.map((genre, idx) => (
                                    <MenuItem key={idx} value={genre.id}>{genre.description}</MenuItem>
                                ))}
                            </Select>
                        </FormControl>
                        ...
                        <Table aria-label="simple table">
                            <TableHead>
                                <TableRow sx={{ backgroundColor: "#e6ddff"}}>
                                    ...
                                    <TableCell align="left" sx={{ fontWeight: 600 }}>Excluir</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                            {genresInMovie.map((row) => (
                                ...
                                >
                                    ...
                                    <TableCell align="left">
                                        <span style={{ cursor: "pointer" }} onClick={() => handleDeleteGenre(row.id)}>
